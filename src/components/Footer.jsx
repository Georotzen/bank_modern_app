  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      ...
      <div className='flex-1 flex flex-col justify-start mr-10'>
        ...
        <p className={`${styles.paragraph} ml-6 mt-4 max-w-[310px]`}>A new way to make the payments easy, reliable and secure.</p>
      </div>
      {/* div for links */}
    ...
    {/* <hr className='h-[2px] my-4 bg-neutral-800 border-0 w-full' /> */}
    {/* div for copyright */}
